<template>
  <div class="sidebar-menu fixed mw-100 bg-cl-secondary" :class="{ active: isOpen }">
    ...
    <div class="row middle-xs sidebar-menu__right-buttons center-xs">
      <div class="col-xs">
...
import SubBtn from 'theme/components/SidebarMenu/SubBtn'
import SubCategory from 'theme/components/SidebarMenu/SubCategory'
